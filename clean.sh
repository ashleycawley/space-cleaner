...
echo "
Deleting Old/Archive Message Logs...
`ls /var/log/messages-* 2>/dev/null`
"
rm -f /var/log/messages-* 2>/dev/null

echo "
Deleting Old/Archive Cron Logs....
